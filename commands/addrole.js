exports.run = (client, message, args) => {
  ...
  if (!member) return message.channel.send({embed:{title:`<:alert:730778124819628084> **__Označi korisnika__**`,description:"Nisi označio/la korisnika kom želiš dodeliti ulogu!", color: 0x36393f}});
  ...
  if (!message.mentions.roles.first() && args[1])
    ...
    return message.channel.send({embed:{title:`<:alert:730778124819628084> **__Nepravilan unos__**`,description:"Nisi označio/la ulogu ili napisao njeno ime!", color: 0x36393f}});
  ...
  if (
    ...
    return message.channel.send({embed:{title:`<:alert:730778124819628084> **__Greška__**`,description:"Ne možeš dati veću ulogu od svoje!", color: 0x36393f}});

  if (member.roles.cache.has(role.id))
    return message.channel.send({embed:{title:`<:alert:730778124819628084> **__Greška__**`,description:member.toString() + " već ima tu ulogu!", color: 0x36393f}});
  ...
  member.roles
    ...
    .catch(err =>
      message.channel.send({embed:{title:`<:alert:730778124819628084> **__Greška__**`,description:"Nisam mogao dodeliti ulogu tom korisniku zbog: " + err, color: 0x36393f}})
    );
};
exports.conf = {
